	...
	function astra_default_strings( $key, $echo = true ) {
		...
		$defaults = apply_filters(
			...
			array(
				...
				'string-comment-title-reply'             => __( 'Ostavite komentar', 'astra' ),
				'string-comment-cancel-reply-link'       => __( 'Cancel Reply', 'astra' ),
				'string-comment-label-submit'            => __( 'Objavite komentar &raquo;', 'astra' ),
				'string-comment-label-message'           => __( 'Napišite..', 'astra' ),
				...
				'string-blog-meta-leave-a-comment'       => __( 'Ostavite komentar', 'astra' ),
