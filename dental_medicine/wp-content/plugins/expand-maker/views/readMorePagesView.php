		...
		<?php }
			...
			foreach ($results as $result) { ?>
				...
				<tr>
					...
					<td><?php echo $type; ?></td>
					<td>
						<a class="yrm-crud yrm-edit" href="<?php echo admin_url()."admin.php?page=button&yrm_type=".$type."&readMoreId=".$id.""?>"><?php _e('Edit', YRM_LANG); ?></a>
						<a class="yrm-crud yrm-delete-link" data-id="<?php echo $id;?>" href="<?php echo admin_url()."admin-post.php?action=delete_readmore&readMoreId=".$id.""?>"><?php _e('Delete', YRM_LANG); ?></a>
                        <a class="yrm-crud yrm-clone-link fa fa-clone" href="<?php echo admin_url();?>admin-post.php?action=read_more_clone&id=<?php echo $id; ?>" ><?php _e('Clone', YRM_LANG); ?></a>
					</td>
				</tr>
		<?php } ?>
